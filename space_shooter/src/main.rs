...
use game::{
    ...
    move_asteroids, move_bullets, player_asteroid_collision, player_movement, player_shoot,
    spawn_asteroids, spawn_player,
};
use score::{check_and_save_high_score, load_high_score};
use ui::{
    check_game_over, play_again, restart_game, spawn_score_text, update_score_text,
};
